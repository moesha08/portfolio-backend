...
- Clone the repository, install -dependencies, configure environment variables, and start the development server using npm run dev.

🚀 Deployment:
- Deployed on Render.com using MongoDB Atlas as the cloud database.

🧪 Testing the API
- Tested using Thunder Client/Postman with CRUD requests.

📊Features Implemented:
- All assignment requirements met with additional features like error handling, input validation, and deployment.
